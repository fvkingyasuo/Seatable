...
// pang fetch ng mga events ng mga organizer
$stmt = $conn->prepare("
...
<div class="logo-holder">
    ...
    try {
        var event = eventData;
        var seatPrice = 300; // Assuming each seat costs 300
        var printWindow = window.open('', '_blank');
        printWindow.document.write('<html><head><title>Receipt</title>');
        printWindow.document.write('<style>');
        printWindow.document.write('body { text-align: center; }'); // Align content in the center
        printWindow.document.write('</style>');
        ...
        printWindow.document.write('<p><strong>Seat Price: </strong>₱' + seatPrice + '</p>'); // Display total price
        printWindow.document.write('<p><strong>Booked by: </strong>' + customerName + '</p>'); // Display customer's name
