...
// pang check kung organizer yung user
if (!isset($_SESSION['user_id']) || $_SESSION['role'] != 'organizer') {
    header('Location: login.php');
    exit;
}

// pangkuha ng username ng organizer 
...
if ($user_result->num_rows > 0) {
    ...
    // pag walang makitang organizer
    $username = 'Unknown Organizer';
}
$user_stmt->close();

// pang check ng event id kung valid
...
// pangkuha ng booked seats at yung mga customer na nagbook ng seat
$query = "
...
// pang check kung nasubmit naba yung form
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $seat_number = $_POST['seat_number'];
    $_SESSION['seat_number'] = $seat_number;
    $_SESSION['event_id'] = $event_id;

    // pang redirect sa payment
