...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // pang check kung naselect naba yung date para sa ibang event
    ...
    if ($event_count > 0) {
        ...
        try {
            // pang insert sa table ng events
            ...
            // pangkuha  ng id para sa bagong gawang event
            $event_id = $stmt->insert_id;
            // pang insert ng seats
...
<script>
    document.querySelector(".main-content form").addEventListener("submit", function(event) {
        ...
        if (titleInput.value.trim() === "") {
            ...
            event.preventDefault(); // para di masubmit pag di nameet yung requirements
        }
