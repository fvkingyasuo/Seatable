...
// Retrieve the username of the logged-in organizer
...
// Retrieve the events created by the organizer
...
// Calculate the total sales of the organizer
$total_sales_sql = "
...
// Retrieve the events created by the organizer in May
...
while ($event = $may_events->fetch_assoc()) {
    ...
    // Calculate the sales for each event
...
<body>  
    ...
    <div class="main-content">
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                $events->data_seek(0); // Reset the result set pointer to the beginning
                while ($event = $events->fetch_assoc()) {
                    ...
                    echo "<td><a href='view_booked_seats.php?event_id={$event_id}' class='btn btn-primary'>View Booked Seats</a></td>"; // Add button
                    echo "</tr>";
    ...
    <script>
        ...
        // Use the specified configuration item and data
    ...
    try {
        ...
        // pangkuha ng mga sales ng kada event
